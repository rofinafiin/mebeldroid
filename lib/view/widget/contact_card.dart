    ...
    return Dismissible(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            if (ctRes.success != true) _buildDataRow('Success', ctRes.success),
            _buildDataRow('Message', ctRes.status),
            _buildDataRow('data', ctRes.data),
          ],
        ),
      ),
    );
